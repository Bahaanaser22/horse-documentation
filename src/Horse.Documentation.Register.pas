unit Horse.Documentation.Register;
...
type
  THorseDocumentationRegister = class(TGBSwaggerPathRegistry)
  private
...
{ THorseDocumentationRegister }

class function THorseDocumentationRegister.GetPathMethod(AClass: TClass; AEndPoint: SwagEndPoint): string;
var
  LPathAttr: SwagPath;
  LPathName: string;
  LBasePath: string;
...
class procedure THorseDocumentationRegister.RegisterMethod(AClass: TClass; AMethod: TRttiMethod);
var
...
class procedure THorseDocumentationRegister.RegisterMethodAuth(AClass: TClass; AMethod: TRttiMethod);
var
...
class procedure THorseDocumentationRegister.RegisterMethods(AClass: TClass; APath: SwagPath);
var
  I, J: Integer;
...
class procedure THorseDocumentationRegister.RegisterPath(AClass: TClass);
var
  LPath: SwagPath;
begin
  inherited;
